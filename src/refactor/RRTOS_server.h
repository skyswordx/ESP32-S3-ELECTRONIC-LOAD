 ...
 * @date 2025-05-15
 * @details 提供RRTOS系统的服务器功能
 */

#ifndef RRTOS_SERVER_H
#define RRTOS_SERVER_H
...
public:
    ...
    Server(const std::string& name, ServiceCallbackType cb)
        ...
        // 创建请求队列
        requestQueue = xQueueCreate(10, sizeof(typename ServiceType<ReqT, RespT>::Pair*));
